        ...
        <div className={styles.container}>
            <div className={styles.content}>
                <ProductCard
                    ...
                    preco="R$ 8.999,00"
                    desc="O mais avançado iPhone já criado, com chip A17 Pro e sistema de câmeras profissional."
                    star="(4.8)"
                    qntStar="1.234"
                />
                ...
                <ProductCard
                    ...
                    preco="R$ 7.499,00"
                    desc="Galaxy AI revolucionário, S Pen integrada e câmera de 200MP para fotos incríveis."
                    star="(4.7)"
                    qntStar="987"
                />
                ...
                <ProductCard
                    ...
                    preco="R$ 15.999,00"
                    desc="Performance profissional com chip M3 Pro, tela Liquid Retina XDR e bateria de longa duração."
                    star="(4.9)"
                    qntStar="2.156"
                />
                ...
                <ProductCard
                    ...
                    preco="R$ 6.799,00"
                    desc="Ultrabook premium com design ultrafino, tela InfinityEdge e performance excepcional."
                    star="(4.6)"
                    qntStar="543"
                />
